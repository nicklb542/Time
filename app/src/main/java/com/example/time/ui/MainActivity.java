...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSkycon = findViewById(R.id.tv_skycon);
        tvCity = findViewById(R.id.title_city);
        tvApparentTemperature = findViewById(R.id.tv_apparenttemperature);
        ...
        btFresh = findViewById(R.id.bt_freshen);
        btThDay = findViewById(R.id.bt_thday);
    ...
    public void locationUpdates(Location location) {
        if (location != null) {
            ...
            String stringBuilder = "您的位置是：\n" +
                    "经度" +
                    "\n纬度";
            tvCity.setText(stringBuilder);
        }
    }
                ...
                try {
                    if (response.body() != null) {
                        ...
                        for (int i = 0; i < 3; i++) {
                            ...
                            switch (i) {
                                case 0:
                                    tvTime1.setText("日期：" + date + "\n最高气温：" + max + "°C 最低气温：" + min + "°C 平均气温：" + avg + "°C\n");
                                    break;
                                case 1:
                                    tvTime2.setText("日期：" + date + "\n最高气温：" + max + "°C 最低气温：" + min + "°C 平均气温：" + avg + "°C\n");
                                    break;
                                case 2:
                                    tvTime3.setText("日期：" + date + "\n最高气温：" + max + "°C 最低气温：" + min + "°C 平均气温：" + avg + "°C\n");
                                    break;
                            }
                        }
                    } else {
                        for (int i = 0; i < 3; i++) {
                            switch (i) {
                                case 0:
                                    tvTime1.setText("日期：null\n" + " 最高气温：null" + " 最低气温：null" + " 平均气温：null");
                                    break;
                                case 1:
                                    tvTime2.setText("日期：null\n" + " 最高气温：null" + " 最低气温：null" + " 平均气温：null");
                                    break;
                                case 2:
                                    tvTime3.setText("日期：null\n" + " 最高气温：null" + " 最低气温：null" + " 平均气温：null");
                                    break;
                            }
                        }
